      ...
      <div class="container">
        <div class="columns is-centered">
          <div class="column is-6-tablet is-5-desktop is-4-widescreen">
            ...
            <div class="box">
              <h4 class="title is-4 has-text-centered inscrire"><b>S'inscrire</b></h4>
              <h6 class="subtitle has-text-centered is-6 reponse">{{responseMessage}}</h6>
             <div class="field">
                <label class="label">Pseudo</label>
                <div>
                  <input v-model="uname" class="input is-small" type="text" placeholder="Veuillez saisir votre psuedo" required/>
                </div>
              </div>
              ...
              <div class="field">
                ...
                <div>
                  <input v-model="mail" class="input is-small" type="email" placeholder="Veuillez saisir votre @mail" required/>
                </div>
              </div>
            ...
            <div class="box"> Vous avez déjà un compte ? <router-link class="is-text" to="/">Se connecter</router-link > 
            </div>
          </div>
        </div>
      </div>
